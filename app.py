...
@global_options
def mnist_test(k_nn):
    train_images, train_labels = get_mnist_train_images('/Users/perjohn/data/MNIST')
    test_images, test_labels = get_mnist_test_images('/Users/perjohn/data/MNIST')
...
def mnist_cross_validate():
    images, labels = get_mnist_train_images('/Users/perjohn/data/MNIST')
